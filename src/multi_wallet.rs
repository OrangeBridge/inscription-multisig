...
use bdk::{electrum_client, FeeRate, KeychainKind, LocalUtxo, SignOptions, TransactionDetails, Wallet};
use dotenv::dotenv;
...
impl MultiWallet {
    ...
    pub fn transfer_insc_zero_fee(&self,inscription:Inscription,to:Address)->Result<(Psbt, TransactionDetails)> {
        ...
        let fee = psbt.inputs[0].clone();

        psbt.inputs[0] = psbt.inputs[1].clone();
        psbt.inputs[1] = fee;
...
async fn xfer_insc_psbt(){
    ...
    match wallet {
        Ok(mut wallet) => {
            let ins = Inscription{
                id:"b72152427085febf9b36c6d271338e01011013f195c442dcae12496d7b8fc602i0".to_string(),
                location:"b72152427085febf9b36c6d271338e01011013f195c442dcae12496d7b8fc602:0:0".to_string()
            };
